...
//   vc_com = (Period_PWM>>1) + _IQ1div(_IQ1mpy(Period_PWM,vc),Vdcbus);
   ...
   float Period_PWM_f   = (float)Period_PWM;   // ��� period �� float
   float vc_f                   = (float)vc;            // ��� sine reference
   float va_f                   = (float)va;            // ��� sine reference
   float Vdcbus_f           = (float)Vdcbus;        // ��� Vdc bus ����������
